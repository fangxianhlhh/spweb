...
public class PageBean {
	...
	private int viewsize; // 每页有多少行[默认为20行].
	...
	public int getPageCount() {
		try {
			this.pagecount = ((this.rscount - 1) / this.getviewsize()) + 1;
		} catch (Exception ex) {
			this.pagecount = 0;
		}
	...
	public String pagetool(String flag) {
		...
		if (flag.equals(PageBean.Text)) {
			...
			str.append("共有" + "<span style='color: red;'>"+this.rscount +"</span>" + "条记录&nbsp;&nbsp;");
			str.append("共" + "<span style='color: red;'>"+this.pagecount  +"</span>"+ "页&nbsp;&nbsp;");
			str.append("每页" + "<span style='color: red;'>"+this.getviewsize()  +"</span>"+ "条记录&nbsp;&nbsp;");
			str.append("现在" + "<span style='color: red;'>"+this.currentpage + "</span>"+ "/" +"<span style='color: red;'>"+this.pagecount+ "</span>"+"页");
			...
			str.append("document.pageform.do='" + url
					+ "&currentpage='+testpage+'';");
			str.append("document.pageform.submit();");
			str.append("}");
			str.append("</script>");
			str.append("</form>");
		} else if (flag.equals(PageBean.Image)) {
			/**
			 * 图片的分页
			 */

		} else if (flag.equals(PageBean.BbsText)) {
			/**
			 * 论坛形式的分页[直接以数字方式体现]
			 */
			str
			...
			str.append("</td><td width='3%'>&nbsp;</td></tr></table>");
		} else if (flag.equals(PageBean.BbsImage)) {
			/**
			 * 论坛形式的分页[以图片的方式体现]
			 */
			// 设定分页显示的CSS
	...
	public String getParamUrl() {
		...
		while (params.hasMoreElements()) {
			String tempName = (String)params.nextElement();
