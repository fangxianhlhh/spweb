	...
	loading:function(option){
		...
		if(all=="1"){
			...
			html_loading = "<div id='loading' style='position:absolute;width:100%;height:100%;left:0px;top:0px;background:#E0ECFF;opacity:0.8;filter:alpha(opacity=80);z-index:99999;'>"+  
			 "<div style='position:absolute;  cursor1:wait;left:"+loading_offset_left+"px;top:"+loading_offset_top+"px;width:auto;height:16px;padding:12px 5px 10px 30px;"+  
			 "background:#fff url(../js/jquery-easyui-1.4.3/themes/default/images/loading.gif) no-repeat scroll 5px 10px;border:2px solid #ccc;color:#000;'>"+content+ 
			 "</div></div>";
